...
export const Chatbar = ({setOpenedChatTag,socket}) => {
...
const handleSubmit=(e)=>{
  ...
  return (
    <>
      <div
        className="position-fixed  p-2 top-0  h-100 text-center bg-dark"
      ...
      >
        ...
        <div
          className="w-100 mt-3 mx-1 border border-1 border-white rounded-3"
          style={{ height: "70%" }}
        >
        ...
        <form
          ...
          className=" d-flex  w-100   mt-2   rounded-3"
        >
          <input
